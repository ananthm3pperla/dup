...
-- Create simplified team_members policies with new names to avoid conflicts
...
-- Create simplified work_schedules policies with new names
...
-- Create simplified checkins policies with new names
