import { Calendar, CustomRenderingStore } from "./chunk-M4O6YPK6.js";
...
var reactMajorVersion = parseInt(
  String(import_react.default.version).split(".")[0],
);
...
var FullCalendar = class extends import_react.Component {
  ...
  render() {
    ...
    for (const customRendering of this.state.customRenderingMap.values()) {
      customRenderingNodes.push(
        import_react.default.createElement(CustomRenderingComponent, {
  ...
  componentDidMount() {
    ...
    this.handleCustomRendering =
      customRenderingStore.handle.bind(customRenderingStore);
