"use client";
import { require_react_dom } from "./chunk-JY3LWUAG.js";
...
var ee = import_react2.default.createElement(
  "svg",
  {
...
var oe = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24",
...
var ae = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var se = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var Ot = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "12",
  ...
  constructor() {
    ...
    this.promise = (e, t) => {
      ...
      let u = e instanceof Promise ? e : e(),
        ...
        g = () =>
          new Promise((i, D) =>
            S.then(() => (w[0] === "reject" ? D(w[1]) : i(w[1]))).catch(D),
          );
...
var ve = (n) => {
  ...
  let {
    ...
    [Y, C] = import_react.default.useState(null),
    [lt, J] = import_react.default.useState(null),
    [W, H] = import_react.default.useState(false),
    [A, mt] = import_react.default.useState(false),
    [L, z] = import_react.default.useState(false),
    [ct, d] = import_react.default.useState(false),
    [h, y] = import_react.default.useState(false),
    [R, j] = import_react.default.useState(0),
    [p, _] = import_react.default.useState(0),
    O = import_react.default.useRef(t.duration || X || Wt),
    G = import_react.default.useRef(null),
    k = import_react.default.useRef(null),
    Vt = g === 0,
    Ut = g + 1 <= w,
    N = t.type,
    ...
    dt = import_react.default.useMemo(
    ...
    Tt = import_react.default.useMemo(
      () => t.duration || X || Wt,
      [t.duration, X],
    ),
    gt = import_react.default.useRef(0),
    U = import_react.default.useRef(0),
    St = import_react.default.useRef(0),
    K = import_react.default.useRef(null),
    [Gt, Qt] = st.split("-"),
    Rt = import_react.default.useMemo(
    ...
    qt = t.invert || e,
    ht = N === "loading";
  (U.current = import_react.default.useMemo(() => dt * pt + Rt, [dt, Rt])),
    ...
    import_react.default.useEffect(() => {
      ...
      if (r) {
        ...
        return (
          _(m),
          f((c) => [{ toastId: t.id, height: m, position: t.position }, ...c]),
  ...
  function Zt() {
    ...
    return P != null && P.loading
      ...
      : rt
        ...
        : import_react.default.createElement(Yt, {
            className: M(
              s == null ? void 0 : s.loader,
  ...
  return import_react.default.createElement(
    "li",
    {
      ...
      className: M(
        ...
        (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast,
      ...
      onPointerUp: () => {
        ...
        if (Math.abs(b) >= ye || I > 0.11) {
          j(U.current),
            ...
            J(Y === "x" ? (r > 0 ? "right" : "left") : m > 0 ? "down" : "up"),
            $(),
            d(true),
            y(false);
          return;
      ...
      onPointerMove: (r) => {
        ...
        if (
          !K.current ||
          !V ||
          ((Q = window.getSelection()) == null ? void 0 : Q.toString().length) >
            0
        )
          return;
        ...
        Y === "y"
          ? (I.includes("top") || I.includes("bottom")) &&
            ((I.includes("top") && c < 0) || (I.includes("bottom") && c > 0)) &&
            (x.y = c)
          : Y === "x" &&
            (I.includes("left") || I.includes("right")) &&
            ((I.includes("left") && b < 0) || (I.includes("right") && b > 0)) &&
            (x.x = b),
    ...
    Jt && !t.jsx
      ...
      : null,
    t.jsx || (0, import_react.isValidElement)(t.title)
      ? t.jsx
        ? t.jsx
      ...
      : import_react.default.createElement(
          ...
          (0, import_react.isValidElement)(t.cancel)
            ? t.cancel
            : t.cancel && tt(t.cancel)
              ? import_react.default.createElement(
                  "button",
                  {
                    ...
                    onClick: (r) => {
                      ...
                      tt(t.cancel) &&
                        V &&
                        ((c = (m = t.cancel).onClick) == null || c.call(m, r),
                        $());
                    },
                    className: M(
              ...
              : null,
          (0, import_react.isValidElement)(t.action)
            ? t.action
              ...
              ? import_react.default.createElement(
                  "button",
                  {
                    ...
                    onClick: (r) => {
                      var m, c;
                      tt(t.action) &&
                        ((c = (m = t.action).onClick) == null || c.call(m, r),
                        !r.defaultPrevented && $());
                    },
                    className: M(
...
var $e = (0, import_react.forwardRef)(function (e, t) {
  let {
    ...
    [B, s] = import_react.default.useState([]),
    P = import_react.default.useMemo(
      () =>
        Array.from(
          new Set(
            [u].concat(B.filter((d) => d.position).map((d) => d.position)),
          ),
        ),
      [B, u],
    ),
    [nt, it] = import_react.default.useState([]),
    [Y, C] = import_react.default.useState(false),
    [lt, J] = import_react.default.useState(false),
    [W, H] = import_react.default.useState(
      T !== "system"
        ? T
    ...
    A = import_react.default.useRef(null),
    mt = f.join("+").replace(/Key/g, "").replace(/Digit/g, ""),
    L = import_react.default.useRef(null),
    z = import_react.default.useRef(false),
    ct = import_react.default.useCallback((d) => {
      s((h) => {
        var y;
        return (
      ...
      P.map((d, h) => {
        ...
        return B.length
          ? import_react.default.createElement(
              ...
              B.filter((p) => (!p.position && h === 0) || p.position === d).map(
                (p, _) => {
                  var O, G;
                  return import_react.default.createElement(ve, {
                    key: p.id,
                    icons: st,
                    index: _,
                    toast: p,
                    defaultRichColors: F,
                    duration:
                      (O = l == null ? void 0 : l.duration) != null ? O : et,
                    ...
                    visibleToasts: ft,
                    closeButton:
                      (G = l == null ? void 0 : l.closeButton) != null ? G : S,
                    interacting: lt,
                    position: d,
