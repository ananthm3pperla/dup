          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div>
              ...
              <p className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">
                ...
                <span className="text-sm sm:text-lg font-normal text-gray-500 dark:text-gray-400 ml-1">
                  days
                </span>
              </p>
            </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              <div className="flex items-center justify-between text-xs sm:text-sm mb-1">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">
                  {balance.total_earned.toFixed(1)} days
                </span>
              </div>
              <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(balance.total_earned / (balance.total_earned + 5)) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between text-xs sm:text-sm mb-1">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">
                  {balance.total_used.toFixed(1)} days
                </span>
              </div>
              <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(balance.total_used / balance.total_earned) * 100}%`,
                  }}
                />
              </div>
            </div>
