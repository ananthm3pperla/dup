...
export default function DashboardHeader({ firstName }: DashboardHeaderProps) {
  ...
  const displayName = isDemoMode() ? DEMO_USER.full_name.split(' ')[0] : firstName;
  ...
  return (
    <div className="mb-6 dashboard-header">
      ...
      >
        ...
        >
          <CheckInButton 
            className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 text-sm font-medium rounded-full bg-primary hover:bg-primary-dark transition-all duration-200 shadow-sm hover:shadow-md" 
          />
          <Link 
            to="/schedule"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
        ...
        >
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">My Office Days</p>
              <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">{weeklyProgress.completed}/{isDemoMode() ? 3 : weeklyProgress.required}</p>
        ...
        >
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Team In Office</p>
              <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">85%</p>
        ...
        >
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">My Remote Days</p>
              <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">4.5</p>
        ...
        >
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">My Engagement</p>
              <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">4.8</p>
