...
import { analyzePulseData, generateWorkRecommendations } from '../../lib/openai';
    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <Card.Content className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className={`px-3 py-1 rounded-full text-sm font-medium ${getSentimentColor(insights.sentiment)}`}>
      ...
      <Card>
        <Card.Content className="text-center py-8">
          ...
          >
            {pulseData.length === 0 ? 'No Data Available' : 'Generate AI Insights'}
          </Button>
        </Card.Content>
      </Card>
    </div>
