    ...
    >
      <div className="flex items-center justify-between mb-4 sm:mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white">My Recent Achievements</h3>
        </div>
      </div>
      <div className="space-y-3 sm:space-y-4">
        {achievements.length > 0 ? (
          achievements.map((achievement, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-xs sm:text-sm font-medium text-default dark:text-white">{achievement.title}</h4>
                <p className="mt-1 text-xs text-muted dark:text-gray-400 line-clamp-2">{achievement.description}</p>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.3 }}
          >
            <p className="text-xs sm:text-sm text-muted dark:text-gray-400">No recent achievements</p>
          </motion.div>
        )}
      </div>
    </motion.div>
