...
export default function OnboardingFlow({ userId, userEmail, initialName = '', onComplete }: OnboardingFlowProps) {
  ...
  const [role, setRole] = useState<'manager' | 'individual_contributor'>('individual_contributor');
  ...
  const handleRoleSelected = (selectedRole: 'manager' | 'individual_contributor') => {
