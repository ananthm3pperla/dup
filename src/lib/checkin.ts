  ...
  try {
    if (isDemoMode()) {
      ...
      return {
        ...
        photo_url: checkInData.photo ? URL.createObjectURL(checkInData.photo) : null,
      ...
      for (let i = 0; i < 7; i++) {
        ...
        if (i % 2 === 0) { // Every other day
          mockCheckins.push({
            ...
            time: '09:30:00',
            photo_url: null,
            location: { latitude: 32.7767, longitude: -96.7970 }, // Dallas coordinates
...
export async function updateTeamCheckInSettings(teamId: string, settings: {
