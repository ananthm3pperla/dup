...
export const pulseAPI = {
  ...
  async getTeamPulseHistory(
    startDate: string,
    endDate: string,
  ): Promise<ApiResponse<PulseCheck[]>> {
    try {
      const response = await fetch(
        `/api/pulse/team?start=${startDate}&end=${endDate}`,
      );
      return await response.json();
    } catch (error) {
...
export const checkinAPI = {
  ...
  async getTeamCheckins(
    ...
    try {
      const response = await fetch(
        `/api/teams/${teamId}/checkins?start=${startDate}&end=${endDate}`,
      );
      return await response.json();
    } catch (error) {
  ...
  async getUserCheckins(
    ...
    try {
      const response = await fetch(
        `/api/users/${userId}/checkins?start=${startDate}&end=${endDate}`,
      );
      return await response.json();
    } catch (error) {
...
export const scheduleAPI = {
  ...
  async getTeamSchedule(
    ...
    try {
      const response = await fetch(
        `/api/teams/${teamId}/schedule?start=${startDate}&end=${endDate}`,
      );
      return await response.json();
    } catch (error) {
  ...
  async getAnchorDays(
    ...
    try {
      const response = await fetch(
        `/api/teams/${teamId}/anchor-days?start=${startDate}&end=${endDate}`,
      );
      return await response.json();
    } catch (error) {
