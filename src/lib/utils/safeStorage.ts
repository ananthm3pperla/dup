...
export function removeItemSafe(storage: Storage, key: string): boolean {
  try {
...
export const localStorage = {
  ...
  remove: (key: string): boolean => removeItemSafe(window.localStorage, key),
...
export const sessionStorage = {
  ...
  remove: (key: string): boolean => removeItemSafe(window.sessionStorage, key),
