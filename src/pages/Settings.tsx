...
import { ThemeSettings, ProfileSettings, AccountSettings } from '@/components/settings';
import { BackButton } from '@/components/navigation/BackButton';
import { toast } from 'sonner';

type SettingsSection = 'profile' | 'account' | 'notifications' | 'appearance' | 'security' | 'preferences';
...
export default function Settings() {
  ...
  const renderNotificationSettings = () => (
    <div className="space-y-6">
      <Card className="p-6">
        <h3 className="text-lg font-medium text-default mb-4">Notification Settings</h3>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Schedule Reminders</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Get reminders for your schedule</p>
              </div>
            </div>
            <button
  ...
  const renderSecuritySettings = () => (
    <div className="space-y-6">
      <Card className="p-6">
        <h3 className="text-lg font-medium text-default mb-4">Security Settings</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-md p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Started 2 hours ago • Chrome on Windows</p>
                </div>
  ...
  const renderPreferencesSettings = () => (
    <div className="space-y-6">
      <Card className="p-6">
        <h3 className="text-lg font-medium text-default mb-4">App Preferences</h3>
        <div className="space-y-4">
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
        ...
        <div className="md:col-span-3">
          {currentSection && (
            ...
            >
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-default">{currentSection.label}</h2>
