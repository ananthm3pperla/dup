...
import { Building2, Users, Clock, AlertCircle, Info, HelpCircle, CheckCircle } from 'lucide-react';
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (name.startsWith('rtoPolicy.')) {
      ...
      setFormData(prev => ({
        ...
        rtoPolicy: {
          ...prev.rtoPolicy,
          [policyField]: name === 'rtoPolicy.required_days' ? parseInt(value) : value
        }
      }));
    } else {
    ...
    try {
      const team = await createTeam(
        ...
        formData.description,
        {
          ...
          core_hours: formData.rtoPolicy.hasCoreHours ? formData.rtoPolicy.core_hours : undefined,
    ...
    return (
      <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <Card className="p-10 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Team Created!</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Your team has been created successfully. You will be redirected to the dashboard...
          </p>
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-8">
        ...
        <h1 className="mt-4 text-2xl font-bold text-gray-900 dark:text-white">Create a New Team</h1>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800 dark:text-red-300">
                {error || (teamError instanceof Error ? teamError.message : 'Failed to create team')}
              </h3>
            </div>
          </div>
        </div>
          ...
          >
            <div className="mb-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-blue-800 dark:text-blue-300">Team Information</h4>
                  <p className="mt-1 text-xs text-blue-700 dark:text-blue-200">
                    Create a team to manage your hybrid work schedule and collaborate with your colleagues.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Examples of good team names:</h3>
          ...
          >
            <div className="mb-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                <Info className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="text-sm font-medium text-blue-800 dark:text-blue-300">RTO Policy Settings</h4>
                  <p className="mt-1 text-xs text-blue-700 dark:text-blue-200">
                    Define your team's return-to-office policy to help coordinate in-person collaboration.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="required_days" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <Tooltip content="Core hours are times when team members should be present in the office">
                  <label htmlFor="hasCoreHours" className="ml-2 block text-sm text-gray-700 dark:text-gray-300 flex items-center">
                    Set core hours
              ...
              {formData.rtoPolicy.hasCoreHours && (
                <div className="pl-6 grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="core_hours_start" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      Start Time
                    </label>
                    <input
                      type="time"
                  ...
                  <div>
                    <label htmlFor="core_hours_end" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      End Time
                    </label>
                    <input
                      type="time"
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">What does this mean?</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                  Your team will need to be in the office{' '}
                  <strong>{formData.rtoPolicy.required_days}{' '}
                    day{formData.rtoPolicy.required_days !== 1 ? 's' : ''}
                  </strong> per week.
                </p>
                
                {formData.rtoPolicy.hasCoreHours && formData.rtoPolicy.core_hours && (
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    During office days, team members should be present between{' '}
                    <strong>{formData.rtoPolicy.core_hours.start}</strong> and{' '}
                    <strong>{formData.rtoPolicy.core_hours.end}</strong> for collaborative work.
                  </p>
                )}
              </div>
            </div>
