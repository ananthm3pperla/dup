          ...
          <Card.Content>
            <div className="space-y-6">
              <div>
                ...
                <select className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  >
                    Set core hours (when team members should be present in
                    office)
                  </label>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Team members receive updates via email
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Team members receive browser notifications
                    </p>
                  </div>
                </div>
                <button
