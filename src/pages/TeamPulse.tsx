...
export default function TeamPulse() {
  ...
  const [filterBy, setFilterBy] = useState<
    "all" | "challenging" | "neutral" | "good" | "attention"
  >("all");
            ...
            <Card className="p-4 bg-success/5 dark:bg-success/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                    {
                      teamPulseData.filter((m) => m.currentMood === "good")
                        .length
                    }
                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400 ml-1">
                      ...
                      {Math.round(
                        (teamPulseData.filter((m) => m.currentMood === "good")
                          .length /
                          Math.max(1, teamPulseData.length)) *
                          100,
                      )}
                      %)
                    </span>
                ...
                <div>
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400 ml-1">
                      (
                      {Math.round(
                        (teamPulseData.filter((m) => m.requiresAttention)
                          .length /
                          Math.max(1, teamPulseData.length)) *
                          100,
                      )}
              ...
              {sortedMembers.map((member) => (
                ...
                >
                  <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-xs text-gray-500 dark:text-gray-400">
                              Updated{" "}
                              {format(
                                new Date(member.lastUpdateTime),
                                "h:mm a",
                              )}
                            </span>
                          </div>
                    ...
                    <ChevronRight
                      className="h-5 w-5 text-gray-300 dark:text-gray-600 group-hover:text-gray-400 dark:group-hover:text-gray-500 transition-colors"
                      aria-hidden="true"
                    />
                  </div>
                </motion.div>
